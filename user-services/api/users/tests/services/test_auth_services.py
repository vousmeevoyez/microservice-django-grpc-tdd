...
from api.users.services.auth import (login, logout, JWTToken)
from api.users.exceptions import (InactiveUserException,
                                  InvalidCredentialsException)
@pytest.mark.django_db
@patch("api.users.services.auth.CLIENT")
...
@pytest.mark.django_db
@patch("api.users.services.auth.JWTToken")
